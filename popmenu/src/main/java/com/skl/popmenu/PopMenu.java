...
public class PopMenu {
    ...
    private void buildAnimateGridLayout() {
        ...
        int rowCount = mMenuItems.size() % mColumnCount == 0 ? mMenuItems.size() / mColumnCount : mMenuItems.size() / mColumnCount + 1;
        int topMargin = (mScreenHeight - 10) / 2;
        ...
        mCloseIv.setImageResource(R.drawable.closeshaer);
        ...
        mAnimateLayout.setOnClickListener(null);
    }
